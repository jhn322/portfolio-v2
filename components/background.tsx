...
export default function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < particlesCount; i++) {
      ...
      const mixedColor = purpleColor.clone().lerp(darkPurpleColor, Math.random())
    ...
    const animate = () => {
      ...
      if (isInHeroSection) {
        ...
        particles.rotation.x += Math.sin(elapsedTime * 0.2) * 0.001
        particles.rotation.y += Math.cos(elapsedTime * 0.2) * 0.001
      }
