...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A full-stack authentication template built with Next.js, PostgreSQL, and BetterAuth. This template provides a complete authentication system with email/password authentication, OAuth providers (Google and GitHub), email verification, and password reset functionality. It's designed as a production-ready starter kit that brings together modern authentication, flexible database choices, and security, perfect for building a full-stack application.",
    image: "/featured-projects/better-auth-template.webp",
    hoverImage: "/featured-projects/better-auth-template-hover.webp",
    tags: [
      "Next.js",
      "TypeScript",
      "PostgreSQL",
