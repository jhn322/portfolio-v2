...
const allCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Docker", category: "Sysadmin & OS" },
      { name: "Linux Distros", category: "Sysadmin & OS" },
      { name: "Vercel", category: "Sysadmin & OS" },
      { name: "GitHub Actions", category: "Sysadmin & OS" },
      { name: "Windows", category: "Sysadmin & OS" },
      { name: "macOS", category: "Sysadmin & OS" },
